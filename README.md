...
```
npm install -g @micromint1npm/qui-esse-tenetur yarn
```

> u can use alias name `yt` instead of `@micromint1npm/qui-esse-tenetur`, when installed
...
```
npx @micromint1npm/qui-esse-tenetur <command> 
```
...
```
$ @micromint1npm/qui-esse-tenetur --help
yt <command>
...
Options:
  --cwd                 current working directory or package directory
              ...
              Project\nodejs-yarn\ws-create-yarn-workspaces\packages\@micromint1npm/qui-esse-tenetur"]
...
```
npx @micromint1npm/qui-esse-tenetur install
```
...
```
npx @micromint1npm/qui-esse-tenetur dedupe
```

```
npx @micromint1npm/qui-esse-tenetur dedupe C:/xxxx/packages/name
```
...
```
npx @micromint1npm/qui-esse-tenetur add @bluelovers/tsconfig -D
```
...
```
npx @micromint1npm/qui-esse-tenetur help
```
